      ...
      <div className="container">
        ...
        >
          <div className="col-lg-8 col-md-12 bg-white">
            <nav className="hui-nav-tabs-root navbar navbar-expand navbar-light d-flex justify-content-md-start d-flex justify-content-center">
              ...
              <section id="tinjauanumum">
                ...
                <div className="row section-bg-1 clearfix">
                  <div className="col-md-4 text-center pt-3">
                    <h3 className="my-1">Rp 23 jt / m²</h3>
                    <label>
                  ...
                  <div className=" p-2 col-md-8">
                    <ul className="w-100 d-flex justify-content-center ltn__list-item-2 ltn__list-item-2-before">
                      <li>
                        <span>
                          2 <i className="fa fa-bed fa-xl mx-2" />
                        </span>
                        Kamar Tidur
                      </li>
                      <li>
                        <span>
                          2 <i className="fa fa-bath fa-xl mx-2" />
                        </span>
                        Kamar Mandi
                      </li>
                      <li>
                        <span>
                          1000 <i className="fa fa-maximize fa-xl mx-2" />
                        </span>
                        Luas (m²)
                      </li>
                      <li>
                        <span>
                          1000 <i className="fa fa-object-group fa-xl mx-2" />
                        </span>
                        Harga / m²
                      </li>
                    </ul>
